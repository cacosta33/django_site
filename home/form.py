...
class ContactForm(forms.Form):
	...
	message = forms.CharField(widget=forms.Textarea(attrs={'class':'form-control', 'id':'message', 'name':'message', 'placeholder':'Enter your message here. I will get back to you as soon as possible', 'rows':'7'}))
